...
Las rutas delegan en AuthController y TaskController. Los controladores validan la entrada y consultan la relación tasks del usuario autenticado; TaskResource limita la respuesta a los campos públicos. Consulta [las decisiones de arquitectura](docs/ARQUITECTURA.md).
...
No se versionan .env, vendor, bases SQLite ni credenciales. Las guías [sesión 04](docs/SESION-04.md) y [sesión 05](docs/SESION-05.md) conservan la evidencia anterior.
